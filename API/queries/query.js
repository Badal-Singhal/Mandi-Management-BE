...
let createReceipt=`INSERT INTO master_data_receipt (user_id, "supplierName", dheri, rate, lab, amount, "finalRate", weight, remarks, photo_path,parchi_no,latitude,longitude,location) 
VALUES (<<user_id>>,<<firmName>>,<<dheri>>,<<rate>>,<<lab>>,<<amount>>, <<finalRate>>, <<weight>>, <<remarks>>,<<photo_path>>,<<parchi_no>>,<<latitude>>,<<longitude>>,<<location>>)`;
